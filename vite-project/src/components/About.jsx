    ...
    <section id="about" className="bg-white py-16 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div className="rounded-[2rem] bg-gradient-to-br from-fuchsia-500 via-rose-400 to-orange-400 p-8 sm:p-10 text-white shadow-2xl shadow-pink-200/40">
          ...
          <div className="space-y-6">
            <div className="rounded-[1.75rem] border border-pink-100 bg-pink-50/80 p-6 sm:p-8 shadow-sm">
            ...
            <div className="rounded-[1.75rem] border border-pink-100 bg-white p-6 sm:p-8 shadow-sm">
