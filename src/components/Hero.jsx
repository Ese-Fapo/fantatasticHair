        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
          <div className="space-y-8 order-1">
            <span className="inline-flex items-center gap-2 rounded-full bg-[#D4AF37]/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.35em] text-[#9B4647] shadow-sm">
              <span className="h-2.5 w-2.5 rounded-full bg-[#9B4647] animate-pulse" />{" "}
              DESDE 1998
            </span>
            <div className="space-y-5">
              <p className="text-base font-semibold uppercase tracking-[0.23em] text-[#9B4647]">
                Fantastic Hair
              </p>
              <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
                O melhor da beleza capilar com perucas e extensões de alto
                brilho.
              </h1>
              <p className="max-w-2xl text-slate-600 text-base leading-8 sm:text-lg">
                Escolha seu estilo entre nossas coleções premium, adicione ao
                carrinho e envie a seleção diretamente para o WhatsApp em
                segundos.
              </p>
            </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-[1.75rem] border border-[#9B4647]/20 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-3 text-slate-600">
                    Seleção rápida e envio direto para o seu WhatsApp, sem
                    complicação.
                  </p>
                </div>
                <div className="rounded-[1.75rem] border border-[#9B4647]/20 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-3 text-slate-600">
                    Atendimento pessoal para ajudar você a escolher a peruca
                    ideal.
                  </p>
                </div>
